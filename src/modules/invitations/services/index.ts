...
/**
 * Service для принятия приглашения в друзья.
 */
export const confirmInvitationService = async (payload: { user_id: string; friend_id: string }) => {
  try {
    ...
    // TODO: Заменить на вызов сервиса добавления в друзья - (addToFriendsService)
    // NOTE: Добавление пользователей в друзья друг друга
